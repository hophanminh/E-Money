  ...
  return (
    <div className={classes.container}>
      <div style={{ display: 'flex', alignItems: 'center', margin: '0px 50px 0px 50px' }}>
        <div style={{ width: '40%', float: 'left', marginRight: '50px' }}>
        ...
        <div style={{ width: '60%', float: 'right', display: 'flex' }}>
          <div>
            <Tooltip title="IDK" aria-label="IDK">
              <Button style={{ width: '300px', height: '400px', backgroundColor: '#1bb55c',
          ...
          <div style={{ width: '300px' }}>
            <Tooltip title="Vào ví cá nhân" aria-label="Vào ví cá nhân">
              <Button style={{ width: '300px', height: '200px', backgroundColor: '#fda92c', 
